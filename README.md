...
Hiervoor hebben een analyse gedaan van data....

### Materiaal
Aan de hand van de bekomen data creëerden we verschillende prototypes. De controller werd gemaakt uit karton, telkens 3 verschillende afmetingen. Na wat benchmarking, zijn we gegaan voor de vorm die we bekomen hebben in semester 1 want deze kwam er positief uit, maar met afgeronden hoeken. De lengte van de controller werd berekend met de handlengte en -breedte. Het gemiddelde werd genomen, en dan 1 keer plus en min de standaardafwijking. Voor de breedte van de controller namen we de lengte van de vingers, wanneer je dit verdubbelt heb je de omtrek. Ook hier namen we het gemiddelde, en 1 keer plus & min de standaardafwijking. Zo hadden we volgende afmetingen: (12,1-4,6 / 10,4-4,1 / 13,8-5,1)cm. 
Voor de band hebben we eerst aan benchmarking gedaan (zie Miro) voor het bepalen van het uiterlijk. Voor stevigheid komt deze vast te zitten tot aan de vingers. De band hebben we gemaakt uit een nylon kous, en met als afmeting de elleboog-hand lengte. 1 band met de gemiddelde lengte van 24 cm.  Uiteindelijk zal de omtrek van de band aan te passen zijn, dus deze moest niet bepaald worden. 
De verbinding tussen de band en de controller is met velcro.

### Methoden

De User testen worden uitgevoerd met 5 respondenten. De respondenten hadden leeftijden tussen 10 en 16 jaar. Als extra hebben we ervoor gekozen om een volwassene toe te voegen, zo wanneer het kind eens met zijn ouder wil spelen, weten we of dit model ook past voor hen. 
